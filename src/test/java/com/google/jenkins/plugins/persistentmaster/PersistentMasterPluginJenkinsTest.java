...
/**
 * Jenkins based tests for {@link PersistentMasterPlugin}.
 */
public class PersistentMasterPluginJenkinsTest {
  ...
  public void testPluginSectionOnMainConfigPage() throws Exception {
    ...
    WebAssert.assertTextPresent(configPage, "Persistent Master Backup Plugin");
  ...
  public void testConfigurePlugin() throws Exception {
    ...
    LocalFileStorageProvider provider =
        (LocalFileStorageProvider) PersistentMasterPlugin.getInstance()
            .getStorageProvider();
