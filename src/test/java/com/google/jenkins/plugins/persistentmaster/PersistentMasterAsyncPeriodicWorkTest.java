...
/**
 * Tests for {@link PersistentMasterAsyncPeriodicWork}.
 */
public class PersistentMasterAsyncPeriodicWorkTest {
  ...
  private PersistentMasterAsyncPeriodicWork periodicWork;
  ...
  public void setUp() throws Exception {
    ...
    when(jenkins.getPlugin(eq(PersistentMasterPlugin.class)))
        .thenReturn(plugin);

    periodicWork = new PersistentMasterAsyncPeriodicWork();
  ...
  public void test_noPluginInstance_shouldThrowException() throws Exception {
    when(jenkins.getPlugin(eq(PersistentMasterPlugin.class))).thenReturn(null);
