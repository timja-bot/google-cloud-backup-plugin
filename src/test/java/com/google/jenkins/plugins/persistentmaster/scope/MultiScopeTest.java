...
public class MultiScopeTest {
  ...
  @Mock private Volume.Creator creator;
  @Mock private Volume.Extractor extractor;
  @Mock private Volume.Entry entry1;
  @Mock private Volume.Entry entry2;
  @Mock private Scope scope1;
  @Mock private Scope scope2;
  ...
  @Test
  public void testExtractFiles_prefixRemovedAndSeparateIteratorsForEachScope()
      throws Exception {
    // use answer, b/c a new instance needs to be returned for each invocation
    when(extractor.iterator()).thenAnswer(new Answer<Object>() {
      @Override
