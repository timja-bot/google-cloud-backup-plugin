...
public class AutoRestoreInitializerTest {
  ...
  @Mock private CloudBackupMainModule module;
  ...
  public void setUp() throws Exception {
    ...
    mockStatic(CloudBackupPlugin.class);
    ...
    when(CloudBackupPlugin.getInstance()).thenReturn(plugin);
    when(plugin.getCloudBackupMainModule()).thenReturn(module);
  ...
  public void testInit_exitWithNullModule() throws Exception {
    when(plugin.getCloudBackupMainModule()).thenReturn(null);
    AutoRestoreInitializer.init();
