...
/**
 * Tests for {@link CloudBackupPlugin}.
 *
 * @author akshayd@google.com (Akshay Dayal).
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest(CloudBackupPlugin.class)
public class CloudBackupPluginTest {

  @Test
  public void testStartBehavior() throws Exception {
    CloudBackupPlugin plugin = spy(new CloudBackupPlugin());
