 ...
 * specified if the two are otherwise equal. A non version (null version) is always
 * less than a non null version 
 * <p>
 * Examples:
 * {@code null < 1.1 < 1.1.2 < 1.2.1 < 1.2.2 < 1.5 < 1.12 < 1.13 < 1.1-beta < 1.1beta }
 */
